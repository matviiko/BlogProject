...
export class CategoriesService {
  ...
  create(category: Category): Observable<Category> {
    return this.http.post<Category>(`${environment.fbDbUrl}/categories.json`, category).pipe(
  ...
  getAllCategories(): Observable<Category[]> {
    return this.http.get(`${environment.fbDbUrl}/categories.json`).pipe(
  ...
  getCategoryById(id: string): Observable<Category> {
    return this.http.get<Category>(`${environment.fbDbUrl}/categories/${id}.json`).pipe(
